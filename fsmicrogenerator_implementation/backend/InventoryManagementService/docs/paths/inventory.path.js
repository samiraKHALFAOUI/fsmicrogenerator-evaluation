 ...
 * tags:
 *   - name: inventory
 *     description: REST API endpoints to manage inventory resources.
 */
 ...
 *   get:
 *     tags: [inventory]
 *     summary: Retrieve all inventories with state (etatObjet) = 'code-1'
 *     parameters:
 ...
 *   patch:
 *     tags: [inventory]
 *     summary: Archive or activate many inventory based on their ids
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
 ...
 *   post:
 *     tags: [inventory]
 *     summary: Insert multiple inventory documents
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
 ...
 *   patch:
 *     tags: [inventory]
 *     summary: Update many inventories using ids and a patch object
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
 ...
 *   get:
 *     tags: [inventory]
 *     summary: Retrieve a inventory using a custom condition (sent in query)
 *     parameters:
 *       - name: condition
 *         in: query
 *         required: true
...
/**
 * @swagger
 * /inventories/statistiques:
 *   post:
 *     tags: [inventory]
 *     summary: Run custom aggregation pipeline on inventories
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
 ...
 *   get:
 *     tags: [inventory]
 *     summary: Retrieve a inventory by its ID
 *     parameters:
