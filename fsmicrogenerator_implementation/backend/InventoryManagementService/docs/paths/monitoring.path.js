 ...
 * tags:
 *   - name: monitoring
 *     description: Endpoints for InventoryManagement status and monitoring
 */
 ...
 *   get:
 *     tags: [monitoring]
 *     summary: Health check of InventoryManagement and its dependencies
 *     responses:
 *       '200':
 ...
 *                 service:
 *                   type: string
 *                   example: InventoryManagementService
 *                 mongo:
 *                   type: string
 *                   example: CONNECTED
 *                 redis:
