 ...
 * tags:
 *   - name: monitoring
 *     description: Endpoints for CurrencyManagement status and monitoring
 */
 ...
 *   get:
 *     tags: [monitoring]
 *     summary: Health check of CurrencyManagement and its dependencies
 *     responses:
 *       '200':
 ...
 *                 service:
 *                   type: string
 *                   example: CurrencyManagementService
 *                 mongo:
 *                   type: string
 *                   example: CONNECTED
 *                 redis:
