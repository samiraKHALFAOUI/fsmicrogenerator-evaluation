 ...
 * tags:
 *   - name: monitoring
 *     description: Endpoints for TransactionManagement status and monitoring
 */
 ...
 *   get:
 *     tags: [monitoring]
 *     summary: Health check of TransactionManagement and its dependencies
 *     responses:
 *       '200':
 ...
 *                 service:
 *                   type: string
 *                   example: TransactionManagementService
 *                 mongo:
 *                   type: string
 *                   example: CONNECTED
 *                 redis:
