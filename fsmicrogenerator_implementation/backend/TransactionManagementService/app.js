...
// #region Observer and Consumer Declaration
const { InitializeChannel, GetChannel } = require("./helpers/communications");
const {
  TransactionReceiver,
  TransactionObserver,
} = require("./communications/transaction.communication");
const {
  TransactionLineReceiver,
  TransactionLineObserver,
} = require("./communications/transactionLine.communication");
// #endregion

// #region Routes Declaration
const transactionRoutes = require("./routes/transaction.routes");
const transactionLineRoutes = require("./routes/transactionLine.routes");
// #endregion
...
app.use("/health", async (req, res) => {
  ...
  const allOk = mongoConnected && redisConnected && rabbitConnected;
  const response = {
    service: serviceName,
    mongo: mongoStatus,
    redis: redisStatus,
...
app.use("/transactionLines", transactionLineRoutes);
// #endregion
