 ...
 * tags:
 *   - name: group
 *     description: REST API endpoints to manage group resources.
 */
 ...
 *   get:
 *     tags: [group]
 *     summary: Retrieve all groups with state (etatObjet) = 'code-1'
 *     parameters:
 ...
 *   patch:
 *     tags: [group]
 *     summary: Archive or activate many group based on their ids
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
 ...
 *   post:
 *     tags: [group]
 *     summary: Insert multiple group documents
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
 ...
 *   patch:
 *     tags: [group]
 *     summary: Update many groups using ids and a patch object
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
 ...
 *   get:
 *     tags: [group]
 *     summary: Get all translations of a specific group
 *     parameters:
 ...
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/groupGetTranslations'
 *       '404': { $ref: '#/components/responses/NotFound' }
 *       '400': { $ref: '#/components/responses/ApplicationError' }

 *   patch:
 *     tags: [group]
 *     summary: Update or add a translation for a group
 *     parameters:
 *       - $ref: '#/components/parameters/DocId'
 *     requestBody:
 *       required: true
 ...
 *         application/json:
 *           schema:
 *             $ref: '#/components/schemas/groupTranslate'
 *     responses:
 *       '200':
 *         description: object to translate
 *         content:
 ...
 *   get:
 *     tags: [group]
 *     summary: Retrieve a group using a custom condition (sent in query)
 *     parameters:
 *       - name: condition
 *         in: query
 *         required: true
 ...
 *   post:
 *     tags: [group]
 *     summary: Run custom aggregation pipeline on groups
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
