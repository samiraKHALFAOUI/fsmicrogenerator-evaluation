 ...
 * tags:
 *   - name: monitoring
 *     description: Endpoints for TechnicalConfiguration status and monitoring
 */
 ...
 *   get:
 *     tags: [monitoring]
 *     summary: Health check of TechnicalConfiguration and its dependencies
 *     responses:
 *       '200':
 ...
 *                 service:
 *                   type: string
 *                   example: TechnicalConfigurationService
 *                 mongo:
 *                   type: string
 *                   example: CONNECTED
 *                 redis:
