 ...
 * tags:
 *   - name: supplier
 *     description: REST API endpoints to manage supplier resources.
 */
 ...
 *   get:
 *     tags: [supplier]
 *     summary: Retrieve all suppliers with state (etatObjet) = 'code-1'
 *     parameters:
 ...
 *   post:
 *     tags: [supplier]
 *     summary: Create a new supplier (with file upload)
 *     requestBody:
 *       required: true
 *       content:
 *         multipart/form-data:
 ...
 *   patch:
 *     tags: [supplier]
 *     summary: Archive or activate many supplier based on their ids
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
 ...
 *   post:
 *     tags: [supplier]
 *     summary: Insert multiple supplier documents
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
 ...
 *   patch:
 *     tags: [supplier]
 *     summary: Update many suppliers using ids and a patch object
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
/**
 * @swagger
 * /suppliers/translate/{id}:
 *   get:
 *     tags: [supplier]
 *     summary: Get all translations of a specific supplier
 *     parameters:
 ...
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/supplierGetTranslations'
 *       '404': { $ref: '#/components/responses/NotFound' }
 *       '400': { $ref: '#/components/responses/ApplicationError' }

 *   patch:
 *     tags: [supplier]
 *     summary: Update or add a translation for a supplier
 *     parameters:
 *       - $ref: '#/components/parameters/DocId'
 *     requestBody:
 *       required: true
 ...
 *         application/json:
 *           schema:
 *             $ref: '#/components/schemas/supplierTranslate'
 *     responses:
 *       '200':
 *         description: object to translate
 *         content:
 ...
 *   get:
 *     tags: [supplier]
 *     summary: Retrieve a supplier using a custom condition (sent in query)
 *     parameters:
 *       - name: condition
 *         in: query
 *         required: true
...
/**
 * @swagger
 * /suppliers/statistiques:
 *   post:
 *     tags: [supplier]
 *     summary: Run custom aggregation pipeline on suppliers
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
