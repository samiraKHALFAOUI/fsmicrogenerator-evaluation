 ...
 * tags:
 *   - name: monitoring
 *     description: Endpoints for SupplierManagement status and monitoring
 */
 ...
 *   get:
 *     tags: [monitoring]
 *     summary: Health check of SupplierManagement and its dependencies
 *     responses:
 *       '200':
 ...
 *                 service:
 *                   type: string
 *                   example: SupplierManagementService
 *                 mongo:
 *                   type: string
 *                   example: CONNECTED
 *                 redis:
