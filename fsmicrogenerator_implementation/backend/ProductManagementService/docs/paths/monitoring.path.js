 ...
 * tags:
 *   - name: monitoring
 *     description: Endpoints for ProductManagement status and monitoring
 */
 ...
 *   get:
 *     tags: [monitoring]
 *     summary: Health check of ProductManagement and its dependencies
 *     responses:
 *       '200':
 ...
 *                 service:
 *                   type: string
 *                   example: ProductManagementService
 *                 mongo:
 *                   type: string
 *                   example: CONNECTED
 *                 redis:
