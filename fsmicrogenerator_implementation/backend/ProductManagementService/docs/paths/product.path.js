 ...
 * tags:
 *   - name: product
 *     description: REST API endpoints to manage product resources.
 */
 ...
 *   get:
 *     tags: [product]
 *     summary: Retrieve all products with state (etatObjet) = 'code-1'
 *     parameters:
 ...
 *   post:
 *     tags: [product]
 *     summary: Create a new product (with file upload)
 *     requestBody:
 *       required: true
 *       content:
 *         multipart/form-data:
 ...
 *   patch:
 *     tags: [product]
 *     summary: Archive or activate many product based on their ids
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
 ...
 *   post:
 *     tags: [product]
 *     summary: Insert multiple product documents
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
 ...
 *   patch:
 *     tags: [product]
 *     summary: Update many products using ids and a patch object
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
 ...
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/productGetTranslations'
 *       '404': { $ref: '#/components/responses/NotFound' }
 *       '400': { $ref: '#/components/responses/ApplicationError' }

 *   patch:
 *     tags: [product]
 *     summary: Update or add a translation for a product
 *     parameters:
 *       - $ref: '#/components/parameters/DocId'
 *     requestBody:
 *       required: true
 ...
 *         application/json:
 *           schema:
 *             $ref: '#/components/schemas/productTranslate'
 *     responses:
 *       '200':
 *         description: object to translate
 *         content:
 ...
 *   get:
 *     tags: [product]
 *     summary: Retrieve a product using a custom condition (sent in query)
 *     parameters:
 *       - name: condition
 *         in: query
 *         required: true
...
/**
 * @swagger
 * /products/statistiques:
 *   post:
 *     tags: [product]
 *     summary: Run custom aggregation pipeline on products
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
