...
@Component({
  selector: "app-translate-supplier",
  templateUrl: "./translate-supplier.component.html",
  styleUrls: ["./translate-supplier.component.scss"],
})
export class TranslateSupplierComponent {
    ...
    let getData = () => {
      return this.helpers.resolve<Supplier>((res, rej) => {
        this.supplierService
          .getSupplierForTranslation(this.id)
          .pipe(takeUntil(this.destroyed$))
          .subscribe({
            next: (result) => {
              res(result);
  ...
  addData() {
    ...
    if (this.form.invalid) {
      ...
      this.supplierService
        .translateSupplier(this.id, newForm)
        .pipe(takeUntil(this.destroyed$))
        .subscribe({
          next: (result) => {
