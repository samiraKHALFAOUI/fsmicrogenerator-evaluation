...
@Component({
  selector: "app-translate-category",
  templateUrl: "./translate-category.component.html",
  styleUrls: ["./translate-category.component.scss"],
})
export class TranslateCategoryComponent {
    ...
    let getData = () => {
      return this.helpers.resolve<Category>((res, rej) => {
        this.categoryService
          .getCategoryForTranslation(this.id)
          .pipe(takeUntil(this.destroyed$))
          .subscribe({
            next: (result) => {
              res(result);
  ...
  addData() {
    ...
    if (this.form.invalid) {
      ...
      this.categoryService
        .translateCategory(this.id, newForm)
        .pipe(takeUntil(this.destroyed$))
        .subscribe({
          next: (result) => {
